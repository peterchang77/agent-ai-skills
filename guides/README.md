...
Practical, GitHub-readable guides for working effectively with AI coding agents. Each guide lives in its own directory so it can grow independently without turning this repository root into a long index.
...
Create `guides/<topic>/README.md`, give it a task-oriented title, and add it to this index. Prefer examples, decisions, evidence, and useful recovery moves over product-specific instructions or terminology drills.
